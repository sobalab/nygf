...
export type CatalogueItem = {
  ...
  // The circumstance behind the two counts, where there is one: a line the shop
  // only brings in occasionally, a bunch made up by weight rather than by stem,
  // a season. It prints under the counts, so it is the sentence a buyer reads
  // before planning an order around the figures above it.
  //   Only for things a buyer acts on. The office also sent back questions and
  // internal shorthand, and neither belongs on a page a florist is reading.
  packingNote?: string;
  vaseLife?: string;
  care?: string;
  boughtFor?: string;
...
const items: CatalogueItem[] = [
  ...
  // The rest of the wall: what the shop actually supplies off the four lists it
  // buys from — BellaRosa and Qualisa in Ecuador, La Rosaleda, Fiorentina, and
  // Edilberto's Colombia list.
  //   It was all four lists at first, 241 varieties, and the shop cut it back to
  // 114 by hand. What went were the ones a supplier prints but does not actually
  // land here, which is the difference between a catalogue of what is orderable
  // and a catalogue of what has been seen in print. Nothing is filed by which
  // list a name came off any more, so a variety coming back is a line here and a
  // variety going is the same line deleted.
  ...
  },
  {
    ...
    stemsPerBunch: "10",
    stemsPerBox: "50 stems per box at premium grade",
    vaseLife: "7 to 10 days",
  ...
  },
  {
    ...
    stemsPerBunch: "10",
    stemsPerBox: "10 bunches per box",
    vaseLife: "7 to 10 days",
...

  {
    ...
    stemsPerBox: "6 to 8 stems per box at large size",
  ...
  },
  {
    ...
    stemsPerBunch: "7 to 15 stems",
    packingNote: "One stem carries seven or more flowers, so the count is set by the order rather than fixed.",
  ...
  },
  {
    ...
    stemsPerBox: "50 stems per box at super select",
  ...
  },
  {
    ...
    stemsPerBunch: "10",
    stemsPerBox: "10, 20 or 35 depending on grade",
  ...
  },
  {
    ...
    stemLength: "30 to 45cm",
    packingNote: "We bring this in occasionally rather than as a standing line.",
    vaseLife: "5 to 7 days",
  ...
  },
  {
    ...
    stemsPerBunch: "10",
    stemsPerBox: "Holland 160 stems. Ecuador 120 to 150 stems",
  ...
  },
  {
    ...
    stemLength: "55 to 70cm",
    stemsPerBunch: "5 to 7",
    stemsPerBox: "24 bunches per box",
    packingNote: "Bunches are made up by weight, so the stem count moves with the farm.",
    vaseLife: "10 to 14 days",
  ...
  },
  {
    ...
    stemLength: "50 to 70cm",
    stemsPerBunch: "10",
    stemsPerBox: "12 to 15 bunches per box",
  ...
  },
  {
    ...
    stemLength: "50 to 70cm",
    stemsPerBunch: "10",
    stemsPerBox: "14 bunches per box",
    packingNote: "A seasonal line rather than one we hold year round.",
    vaseLife: "10 to 14 days",
  ...
  },
  {
    ...
    stemLength: "60 to 80cm",
    stemsPerBox: "24 bunches per box at super select",
    packingNote: "Packed by grade, so the box count moves with the grade bought.",
    vaseLife: "7 to 10 days",
