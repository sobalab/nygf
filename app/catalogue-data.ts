...
const items: CatalogueItem[] = [
  ...
  { name: "Explorer", slug: "explorer", category: "roses", image: "/media/explorer.webp", colour: "red" },
  { name: "Freedom", slug: "freedom", category: "roses", image: "/media/freedom.webp", colour: "red" },
  { name: "Redvolution", slug: "redvolution", category: "roses", image: "/media/redvolution.webp", colour: "red" },
  { name: "Nena", slug: "nena", category: "roses", image: "/media/nena.webp", colour: "light pink" },
  { name: "Novia", slug: "novia", category: "roses", image: "/media/novia.webp", colour: "light pink" },
  { name: "Sweet Beat", slug: "sweet-beat", category: "roses", image: "/media/sweet-beat.webp", colour: "light pink" },
  { name: "Frutetto", slug: "frutetto", category: "roses", image: "/media/frutetto.webp", colour: "light pink" },
  { name: "Be Sweet", slug: "be-sweet", category: "roses", image: "/media/be-sweet.webp", colour: "light pink" },
  { name: "V.I. Pink", slug: "vi-pink", category: "roses", image: "/media/vi-pink.webp", colour: "hot pink" },
  { name: "Full Monty", slug: "full-monty", category: "roses", image: "/media/full-monty.webp", colour: "hot pink" },
  { name: "Poma Rosa", slug: "poma-rosa", category: "roses", image: "/media/poma-rosa.webp", colour: "hot pink" },
  { name: "Sweet Unique", slug: "sweet-unique", category: "roses", image: "/media/sweet-unique.webp", colour: "medium pink" },
  { name: "Sweet Memory", slug: "sweet-memory", category: "roses", image: "/media/sweet-memory.webp", colour: "medium pink" },
  { name: "Hermosa", slug: "hermosa", category: "roses", image: "/media/hermosa.webp", colour: "medium pink" },
  { name: "Tiffany", slug: "tiffany", category: "roses", image: "/media/tiffany.webp", colour: "peach" },
  { name: "Kahala", slug: "kahala", category: "roses", image: "/media/kahala.webp", colour: "peach" },
  { name: "Felicity", slug: "felicity", category: "roses", image: "/media/felicity.webp", colour: "peach" },
  { name: "Orange Crush", slug: "orange-crush", category: "roses", image: "/media/orange-crush.webp", colour: "orange" },
  { name: "Nexus", slug: "nexus", category: "roses", image: "/media/nexus.webp", colour: "orange" },
  ...
  { name: "High & Orange Magic", slug: "high-and-orange-magic", category: "roses", image: "/media/high-and-orange-magic.webp", colour: "bicolor" },
  { name: "Sweetness", slug: "sweetness", category: "roses", image: "/media/sweetness.webp", colour: "bicolor" },
  { name: "Playa Blanca", slug: "playa-blanca", category: "roses", image: "/media/playa-blanca.webp", colour: "white" },
  { name: "Tibet", slug: "tibet", category: "roses", image: "/media/tibet.webp", colour: "white" },
  { name: "Proud", slug: "proud", category: "roses", image: "/media/proud.webp", colour: "white" },
  { name: "Latina", slug: "latina", category: "roses", image: "/media/latina.webp", colour: "yellow" },
  { name: "High Exotic", slug: "high-exotic", category: "roses", image: "/media/high-exotic.webp", colour: "yellow" },
  { name: "Candlelight", slug: "candlelight", category: "roses", image: "/media/candlelight.webp", colour: "beige" },
  { name: "Andrea", slug: "andrea", category: "roses", image: "/media/andrea.webp", colour: "lavender" },
  { name: "Ocean Song", slug: "ocean-song", category: "roses", image: "/media/ocean-song.webp", colour: "lavender" },
  { name: "Cool Down", slug: "cool-down", category: "roses", image: "/media/cool-down.webp", colour: "lavender" },
  { name: "Moody Blue", slug: "moody-blue", category: "roses", image: "/media/moody-blue.webp", colour: "lavender" },
  { name: "Cool Water", slug: "cool-water", category: "roses", image: "/media/cool-water.webp", colour: "lavender" },
  {
    name: "Tinted Rose",
    slug: "tinted-rose",
    category: "roses",
