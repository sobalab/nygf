...
const PLACEMENT: Spot[] = [
  ...
  { above: "clamp(168px,19%,320px)", l: "24%", w: "clamp(96px,13vw,200px)", ratio: "1/1", hcap: 0.24, depth: 1.3 },
  { above: "clamp(140px,16%,280px)", l: "49%", w: "clamp(124px,18vw,268px)", ratio: "5/4", hcap: 0.28, depth: 2.1, mt: "5%", ml: "3%", mw: "min(38vw,166px)" },
  ...
  { below: "clamp(178px,23%,340px)", l: "7%", w: "clamp(120px,19.5vw,300px)", ratio: "4/3", hcap: 0.24, depth: 3, mBelow: "clamp(165px,18%,280px)", ml: "3%", mw: "min(38vw,166px)" },
  { below: "clamp(140px,16%,280px)", l: "44%", w: "clamp(112px,15vw,210px)", ratio: "4/5", hcap: 0.3, depth: 1.1 },
  { below: "clamp(165px,21.5%,320px)", r: "9%", w: "clamp(108px,17vw,272px)", ratio: "1/1", hcap: 0.26, depth: 2.2, mBelow: "clamp(140px,15%,240px)", mr: "3%", mw: "min(35vw,150px)" },
];
